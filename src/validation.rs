use super::cperror::GenerationError;
use super::generation::type_string;
...
mod tests {
    ...
    fn homogenous_arrays() {
        validate_array_test(&[]).unwrap();
        validate_array_test(&[GenericValue::Unit]).unwrap();
        validate_array_test(&[GenericValue::Unit, GenericValue::Unit]).unwrap();
        validate_array_test(&[GenericValue::I64(0), GenericValue::I64(1)]).unwrap();
        validate_array_test(&[
